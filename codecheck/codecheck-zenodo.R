...
my_token <- Sys.getenv("ZENODO_TOKEN")
...
record = get_zenodo_record(zenodo, metadata)
...
codecheck:::set_zenodo_certificate(zenodo, record$parent$id, "codecheck/codecheck.pdf")
